import{_ as l}from"./plugin-vue_export-helper.21dcd24c.js";import{r as i,o,c as r,a as n,e as a,F as t,b as s,f as c}from"./app.af021222.js";const d={},p=n("h2",{id:"profile-inheritance-and-overlays",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#profile-inheritance-and-overlays","aria-hidden":"true"},"#"),s(" Profile Inheritance and Overlays")],-1),m=n("p",null,"In addition to its own controls, an InSpec profile can bring in the controls from another InSpec profile. Additionally, when inheriting the controls of another profile, a profile can skip or even modify those included controls.",-1),u=n("p",null,"When a profile includes controls from another profile, it is usually referred to as a \u201Cmeta profile\u201D or a \u201Cprofile overlay.\u201D Those of us with Chef background sometimes call it a \u201Cwrapper profile\u201D.",-1),v={class:"custom-container tip"},b=n("p",{class:"custom-container-title"},"Further information on inheritance",-1),k=s("You can find out more about inhertiance here "),g={href:"https://www.inspec.io/docs/reference/profiles/#sts=Profile%20Dependencies",target:"_blank",rel:"noopener noreferrer"},h=s("https://www.inspec.io/docs/reference/profiles/#sts=Profile%20Dependencies"),y=c(`<h3 id="defining-the-profile-dependency" tabindex="-1"><a class="header-anchor" href="#defining-the-profile-dependency" aria-hidden="true">#</a> Defining the Profile Dependency</h3><p>Before a profile can use controls from another profile, the to-be-included profile needs to be specified in the including profile\u2019s inspec.yml file in the depends section. For each profile to be included, a location for the profile from where to be fetched and a name for the profile should be included. For example:</p><div class="language-yaml ext-yml line-numbers-mode"><pre class="language-yaml"><code><span class="token key atrule">depends</span><span class="token punctuation">:</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>Once defined in the inspec.yml, controls from the included profiles can be used!</p><h3 id="including-all-controls-from-a-profile" tabindex="-1"><a class="header-anchor" href="#including-all-controls-from-a-profile" aria-hidden="true">#</a> Including All Controls from a Profile</h3><p>With the include_controls command in a profile, all controls from the named profile will be executed every time the including profile is executed.</p><p><code>my_nginx</code> profile</p><div class="language-ruby ext-rb line-numbers-mode"><pre class="language-ruby"><code>control <span class="token string-literal"><span class="token string">&#39;nginx-version&#39;</span></span> <span class="token keyword">do</span>
...
control <span class="token command-literal"><span class="token command string">\`second-overlay-control\`</span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>In the above example, all controls from <code>my_nginx</code> profile and <code>my_nginx_overlay</code> profile will be executed every time my-app-profile is executed <strong>except</strong> for control <code>second-overlay-control</code> from the <code>my_nginx_overlay</code> profile.</p><h3 id="modifying-a-control" tabindex="-1"><a class="header-anchor" href="#modifying-a-control" aria-hidden="true">#</a> Modifying a Control</h3><p>Let\u2019s say a particular control from an included profile should still be run, but the impact isn\u2019t appropriate? Perhaps the test should still run, but if it fails it should be treated as low severity instead of high severity?</p><p>When a control is included, it can also be modified!</p><p><code>my_nginx</code> profile</p><div class="language-ruby ext-rb line-numbers-mode"><pre class="language-ruby"><code>control <span class="token string-literal"><span class="token string">&#39;nginx-version&#39;</span></span> <span class="token keyword">do</span>
  impact <span class="token number">1.0</span>
  title <span class="token string-literal"><span class="token string">&#39;NGINX version&#39;</span></span>
  desc <span class="token string-literal"><span class="token string">&#39;The required version of NGINX should be installed.&#39;</span></span>
<span class="token keyword">end</span>
...
control <span class="token command-literal"><span class="token command string">\`fourth-overlay-control\`</span></span>
control <span class="token command-literal"><span class="token command string">\`fifth-overlay-control\`</span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>As with the prior example, only <code>first-overlay-control</code> and <code>third-overlay-control</code> are executed, but if <code>first-overlay-control</code> fails, it will report with an impact of <code>0.5</code> instead of the originally-intended <code>1.0</code> impact.</p><h3 id="additional-examples" tabindex="-1"><a class="header-anchor" href="#additional-examples" aria-hidden="true">#</a> Additional Examples</h3>`,43),f={href:"https://github.com/mitre/helloworld-web-baseline",target:"_blank",rel:"noopener noreferrer"},w=s("https://github.com/mitre/helloworld-web-baseline"),_={href:"https://github.com/chris-rock/acme-inspec-profile",target:"_blank",rel:"noopener noreferrer"},x=s("https://github.com/chris-rock/acme-inspec-profile"),N={href:"https://github.com/mitre/aws-rds-crunchy-data-postgresql-9-stig-baseline",target:"_blank",rel:"noopener noreferrer"},I=s("https://github.com/mitre/aws-rds-crunchy-data-postgresql-9-stig-baseline");function G(X,T){const e=i("ExternalLinkIcon");return o(),r(t,null,[p,m,u,n("div",v,[b,n("p",null,[k,n("a",g,[h,a(e)])])]),y,n("ul",null,[n("li",null,[n("a",f,[w,a(e)])]),n("li",null,[n("a",_,[x,a(e)])]),n("li",null,[n("a",N,[I,a(e)])])])],64)}var C=l(d,[["render",G],["__file","09.html.vue"]]);export{C as default};
